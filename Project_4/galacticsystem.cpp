...
void galacticsystem::add(body sagan)
{
...
/*void galacticsystem::update(double**& output, int i)
    {
        int j;
        mass_total = 0.0;
...
void galacticsystem::relpositions(double**& relcoord)
{
    int i, j;
...
void galacticsystem::forces(double*& force, const double**& relcoord){
    int j, k;
    int bodies = body_count;
...
/*void galacticsystem::initialize(double**& output, double*& mass, int steps)
            * {
        int i, j;
        int bodies = body_count;
...
void galacticsystem::RK4(double**& output, int steps, double tmax){
...
void galacticsystem::verlet(double**& output, int steps, double tmax){
    int i, j, k, m, n, bodies;
    bodies = body_count;
    double h, halfh, halfhsq, rcubed, fourpisq;
    h = (tmax-0.0)/((double) (steps));
